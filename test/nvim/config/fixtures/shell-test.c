...
static void help(void)
{
    ...
    puts("");
    puts("Usage:");
    puts("    nvim-shell-test --help");
    puts("        Prints this help to stdout.");
    puts("    nvim-shell-test EXE");
    puts("        Prints \"ready $ \" to stderr.");
    puts("    nvim-shell-test -t {prompt text}");
    puts("      Prints \"{prompt text} $ \" to stderr.");
    puts("    nvim-shell-test EXE \"prog args...\"");
    puts("      Prints \"ready $ prog args...\\n\" to stderr.");
    puts("    nvim-shell-test -t {prompt text} EXE \"prog args...\"");
    puts("      Prints \"{prompt text} $ progs args...\" to stderr.");
    puts("    nvim-shell-test REP {byte} \"line line line\"");
