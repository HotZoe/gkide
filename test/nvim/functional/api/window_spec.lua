...
local feed = helper.feed
local eval = helper.eval
local wait = helper.wait
local meths = helper.meths
local funcs = helper.funcs
local clear = helper.clear
local window = helper.window
local buffer = helper.buffer
local curbuf = helper.curbuf
local curwin = helper.curwin
local insert = helper.insert
local command = helper.command
local request = helper.request
local bufmeths = helper.bufmeths
local exc_exec = helper.exc_exec
local meth_pcall = helper.meth_pcall
local curbufmeths = helper.curbufmeths
local curwinmeths = helper.curwinmeths
local feed_command = helper.feed_command
local curbuf_contents = helper.curbuf_contents
