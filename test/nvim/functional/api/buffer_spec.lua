...
local clear, nvim, buffer = helper.clear, helper.nvim, helper.buffer
local curbuf, curwin, eq = helper.curbuf, helper.curwin, helper.eq
local curbufmeths, ok = helper.curbufmeths, helper.ok
