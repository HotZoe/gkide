...
static uchar_kt e_nul_found[] = N_(
                                  "E865: (NFA) Regexp end encountered prematurely");
static uchar_kt e_misplaced[] = N_("E866: (NFA regexp) Misplaced %c");
static uchar_kt e_ill_char_class[] = N_(
 ...
 */
static int nfa_recognize_char_class(uchar_kt *start, uchar_kt *end, int extra_newl)
{
...
#define y_diaeresis 0xff
        ...
        switch(c)
        {
            ...
            case 'D':
                ...
                EMIT2('D');
                EMITMBC(0x10e) EMITMBC(0x110) EMITMBC(0x1e0a)
            ...
            case 'G':
                ...
                EMIT2('G');
                EMITMBC(0x11c) EMITMBC(0x11e) EMITMBC(0x120)
            ...
            case 'H':
                ...
                EMIT2('H');
                EMITMBC(0x124) EMITMBC(0x126) EMITMBC(0x1e22)
            ...
            case 'K':
                ...
                CASEMBC(0x1e34)
                EMIT2('K');
                EMITMBC(0x136) EMITMBC(0x1e8) EMITMBC(0x1e30)
                EMITMBC(0x1e34)
                return;
            ...
            case 'L':
                ...
                EMIT2('L');
                EMITMBC(0x139) EMITMBC(0x13b) EMITMBC(0x13d)
            ...
            case 'R':
                ...
                EMIT2('R');
                EMITMBC(0x154) EMITMBC(0x156) EMITMBC(0x158)
            ...
            case 'S':
                ...
                EMIT2('S');
                EMITMBC(0x15a) EMITMBC(0x15c) EMITMBC(0x15e)
            ...
            case 'T':
                ...
                EMIT2('T');
                EMITMBC(0x162) EMITMBC(0x164) EMITMBC(0x166)
            ...
            case 'W':
                ...
                EMIT2('W');
                EMITMBC(0x174) EMITMBC(0x1e80) EMITMBC(0x1e82)
            ...
            case 'Z':
                ...
                EMIT2('Z');
                EMITMBC(0x179) EMITMBC(0x17b) EMITMBC(0x17d)
            ...
            case 'd':
                ...
                EMIT2('d');
                EMITMBC(0x10f) EMITMBC(0x111) EMITMBC(0x1e0b)
            ...
            case 'g':
                ...
                EMIT2('g');
                EMITMBC(0x11d) EMITMBC(0x11f) EMITMBC(0x121)
            ...
            case 'h':
                ...
                EMIT2('h');
                EMITMBC(0x125) EMITMBC(0x127) EMITMBC(0x1e23)
            ...
            case 'k':
                ...
                CASEMBC(0x1e35)
                EMIT2('k');
                EMITMBC(0x137) EMITMBC(0x1e9) EMITMBC(0x1e31)
                EMITMBC(0x1e35)
                return;
            ...
            case 'l':
                ...
                EMIT2('l');
                EMITMBC(0x13a) EMITMBC(0x13c) EMITMBC(0x13e)
            ...
            case 'r':
                ...
                EMIT2('r');
                EMITMBC(0x155) EMITMBC(0x157) EMITMBC(0x159)
            ...
            case 's':
                ...
                EMIT2('s');
                EMITMBC(0x15b) EMITMBC(0x15d) EMITMBC(0x15f)
            ...
            case 't':
                ...
                EMIT2('t');
                EMITMBC(0x163) EMITMBC(0x165) EMITMBC(0x167)
            ...
            case 'w':
                ...
                EMIT2('w');
                EMITMBC(0x175) EMITMBC(0x1e81) EMITMBC(0x1e83)
            ...
            case 'z':
                ...
                EMIT2('z');
                EMITMBC(0x17a) EMITMBC(0x17c) EMITMBC(0x17e)
...
static int recursive_regmatch(nfa_state_T *state, nfa_pim_T *pim, nfa_regprog_T *prog,
                              regsubs_T *submatch, regsubs_T *m, int **listids)
{
 ...
 */
static long find_match_text(colnr_T startcol, int regstart, uchar_kt *match_text)
{
...
/// match otherwise.
static long nfa_regexec_both(uchar_kt *line, colnr_T startcol, proftime_T *tm)
{
    nfa_regprog_T   *prog;
    long retval = 0L;
    int i;
