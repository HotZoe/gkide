...
///
/// Unlike previous RINGBUF_FORALL uses already defined variable,
/// in place of defining variable in the cycle body.
///
/// @param  rb       Ring buffer to iterate over.
/// @param  RBType   Type of the ring buffer element.
/// @param  varname  Variable name.
...
///                    Actual type name will be @b {TypeName}RingBuffer.
...
///
/// @param TypeName
/// Ring buffer type name.
/// Actual type name will be @b {TypeName}RingBuffer.
///
/// @param funcprefix
/// Prefix for all ring buffer functions.
/// Function name will look like @b {funcprefix}_rb_{function_name}.
/// @param RBType
/// Type of the single ring buffer element.
///
/// @param rbfree
/// Function used to free ring buffer element.
/// May be a macros like `#define RBFREE(item)` (to skip freeing).
///
/// @note
    ...
    {                                                                           \
        ...
        {                                                                       \
            return rb->first + idx;                                             \
                                                                                ...
                                                                                \
    static inline RBType funcprefix##_rb_idx(                                   \
        const TypeName##RingBuffer *const rb, const size_t idx)                 \
    REAL_FATTR_NONNULL_ALL                                                      \
    REAL_FATTR_PURE                                                             \
    REAL_FATTR_UNUSED;                                                          \
