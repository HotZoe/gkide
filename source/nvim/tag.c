...
parse_line:
                ...
                else
                {
                    if(orgpat.regmatch.rm_ic)
                    {
                        ...
                        if(match)
                        {
                            match_no_ic = (STRNCMP(tagp.tagname,
                                                   orgpat.pat,
                                                   cmplen) == 0);
                        }
                    }
...
{
    GA_APPEND(uchar_kt *, &tag_fnames, vim_strsave(fname));
}
                                  ...
                                  int expand)
{
       ...
       && (p = path_tail(tag_fname)) != tag_fname)
    {
        ...
        STRLCPY(retval + (p - tag_fname), fname, MAXPATHL - (p - tag_fname));
