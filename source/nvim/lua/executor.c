...
/// @param  function  Called function
/// @param  numret    Number of returned arguments
/// @param  a1        Supplied argument (should be a void* pointer)
...
/// @param  function  Called function
/// @param  numret    Number of returned arguments
/// @param  a1, a2    Supplied argument (should be a void* pointer)
...
/// @param  function  Called function
/// @param  numret    Number of returned arguments
/// @param  a1,a2,a3  Supplied argument (should be a void* pointer)
...
/// @param  function     Called function
/// @param  numret       Number of returned arguments
/// @param  a1,a2,a3,a4  Supplied argument (should be a void* pointer)
...
Object executor_exec_lua_api(const String str, const Array args, Error *err)
{
    ...
    Object retval = NIL;
    NLUA_CALL_C_FUNCTION_4(global_lstate,
                           nlua_exec_lua_string_api,
                           0,
                           (void *)&str,
                           (void *)&args,
                           &retval,
...
void ex_luafile(exarg_T *const eap) FUNC_ATTR_NONNULL_ALL
{
    ...
    NLUA_CALL_C_FUNCTION_1(global_lstate,
                           nlua_exec_lua_file,
                           0,
                           (void *)eap->arg);
}
