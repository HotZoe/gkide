...
///
/// int mch_print_init(prt_geninfo_st *psettings, uchar_kt *jobname, int forceit)
...
///
/// - int mch_print_begin(prt_geninfo_st *settings)
...
///
/// - void mch_print_end(prt_geninfo_st *psettings)
...
static void prt_get_attr(int hl_id, prt_clrfnt_st *pattr, int modec)
{
    int colorindex;
    uint32_t fg_color;
...
static void prt_line_number(prt_geninfo_st *psettings,
                            int page_line,
                            linenum_kt lnum)
{
    int i;
...
static void prt_header(prt_geninfo_st *psettings, int pagenum, linenum_kt lnum)
{
...
void ex_hardcopy(exargs_st *eap)
{
    ...
    prt_geninfo_st settings;
    size_t bytes_to_print = 0;
    int page_line;
    int jobsplit;
    memset(&settings, 0, sizeof(prt_geninfo_st));
...
int mch_print_begin(prt_geninfo_st *psettings)
{
    time_t now;
    int bbox[4];
    char *p_time;
