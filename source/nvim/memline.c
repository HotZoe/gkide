...
uchar_kt *ml_get_buf(buf_T *buf, linenr_T lnum, int will_change)
{
    bhdr_T *hp;
    DATA_BL *dp;
    uchar_kt *ptr;
...
static void attention_message(buf_T *buf, uchar_kt *fname)
{
    time_t x, sx;
    char *p;
...
/// - 5: quit
/// - 6: abort
static int do_swapexists(buf_T *buf, uchar_kt *fname)
{
