...
MsgpackRequest *Neovim::buffer_get_line_slice(int64_t buffer, int64_t start, int64_t end,
...
MsgpackRequest *Neovim::nvim_buf_get_lines(int64_t buffer, int64_t start, int64_t end,
...
MsgpackRequest *Neovim::buffer_set_line_slice(int64_t buffer, int64_t start, int64_t end,
...
MsgpackRequest *Neovim::nvim_buf_set_lines(int64_t buffer, int64_t start, int64_t end,
...
MsgpackRequest *Neovim::nvim_buf_add_highlight(int64_t buffer, int64_t src_id, QByteArray hl_group,
...
MsgpackRequest *Neovim::nvim_buf_clear_highlight(int64_t buffer, int64_t src_id, int64_t line_start,
                                                 int64_t line_end)
{
...
MsgpackRequest *Neovim::nvim_replace_termcodes(QByteArray str, bool from_part, bool do_lt,
                                               bool special)
{
...
MsgpackRequest *Neovim::buffer_get_lines(int64_t buffer, int64_t start, int64_t end,
                                         bool strict_indexing)
{
...
MsgpackRequest *Neovim::buffer_set_lines(int64_t buffer, int64_t start, int64_t end,
                                         bool strict_indexing, QList<QByteArray> replacement)
{
...
MsgpackRequest *Neovim::buffer_add_highlight(int64_t buffer, int64_t src_id, QByteArray hl_group,
                                             int64_t line, int64_t col_start, int64_t col_end)
{
...
MsgpackRequest *Neovim::buffer_clear_highlight(int64_t buffer, int64_t src_id, int64_t line_start,
                                               int64_t line_end)
{
...
MsgpackRequest *Neovim::vim_replace_termcodes(QByteArray str, bool from_part, bool do_lt,
                                              bool special)
{
