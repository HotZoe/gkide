/// @file snail/libs/nvimcore/function.cpp
...
///
/// Neovim API function identifiers, the list SnailNvimQt::Function::knownFunctions
/// is indexed with this enum.

#ifndef NEOVIMQT_NO_AUTO
    #include "snail/libs/nvimcore/auto/func_sig.hpp"
#endif
