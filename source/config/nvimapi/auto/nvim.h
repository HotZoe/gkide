...
public slots:
    ...
    ///                                  Integer end,
    ///                                  Boolean strict_indexing);
    MsgpackRequest *buffer_get_lines(int64_t buffer,
                                     int64_t start,
                                     int64_t end,
                                     bool strict_indexing);
    ...
    ///                       Boolean strict_indexing,
    ///                       ArrayOf(String) replacement);
    MsgpackRequest *buffer_set_lines(int64_t buffer,
                                     int64_t start,
                                     int64_t end,
                                     bool strict_indexing,
                                     QList<QByteArray> replacement);
    ...
    /// @deprecated nvim API:
    /// Object buffer_get_var(Buffer buffer,
    ///                       String name);
    MsgpackRequest *buffer_get_var(int64_t buffer,
                                   QByteArray name);
    
    /// @deprecated nvim API:
    /// Object buffer_get_option(Buffer buffer,
    ///                          String name);
    MsgpackRequest *buffer_get_option(int64_t buffer,
                                      QByteArray name);
    
    /// @deprecated nvim API:
    /// void buffer_set_option(Buffer buffer,
    ///                        String name,
    ///                        Object value);
    MsgpackRequest *buffer_set_option(int64_t buffer,
                                      QByteArray name,
                                      QVariant value);
    ...
    /// @deprecated nvim API:
    /// void buffer_set_name(Buffer buffer,
    ///                      String name);
    MsgpackRequest *buffer_set_name(int64_t buffer,
                                    QByteArray name);
    ...
    ///                              Integer col_start,
    ///                              Integer col_end);
    MsgpackRequest *buffer_add_highlight(int64_t buffer,
                                         int64_t src_id,
                                         QByteArray hl_group,
                                         int64_t line,
                                         int64_t col_start,
    ...
    ///                             Integer line_start,
    ///                             Integer line_end);
    MsgpackRequest *buffer_clear_highlight(int64_t buffer,
                                           int64_t src_id,
                                           int64_t line_start,
                                           int64_t line_end);
    ...
    /// @deprecated nvim API:
    /// Object tabpage_get_var(Tabpage tabpage,
    ///                        String name);
    MsgpackRequest *tabpage_get_var(int64_t tabpage,
                                    QByteArray name);
    ...
    ///                      Integer height);
    MsgpackRequest *ui_try_resize(int64_t width,
                                  int64_t height);
    ...
    /// @deprecated nvim API:
    /// void vim_feedkeys(String keys,
    ///                   String mode,
    ///                   Boolean escape_csi);
    MsgpackRequest *vim_feedkeys(QByteArray keys,
                                 QByteArray mode,
                                 bool escape_csi);
    ...
    /// @deprecated nvim API:
    /// String vim_replace_termcodes(String str,
    ///                              Boolean from_part,
    ///                              Boolean do_lt,
    ///                              Boolean special);
    MsgpackRequest *vim_replace_termcodes(QByteArray str,
                                          bool from_part,
                                          bool do_lt,
                                          bool special);
    ...
    /// @deprecated nvim API:
    /// Object vim_call_function(String fname,
    ///                          Array args);
    MsgpackRequest *vim_call_function(QByteArray fname,
                                      QVariantList args);
    ...
    /// @deprecated nvim API:
    /// void vim_set_option(String name,
    ///                     Object value);
    MsgpackRequest *vim_set_option(QByteArray name,
                                   QVariant value);
    ...
    /// @deprecated nvim API:
    /// void window_set_height(Window window,
    ///                        Integer height);
    MsgpackRequest *window_set_height(int64_t window,
                                      int64_t height);
    ...
    /// @deprecated nvim API:
    /// void window_set_width(Window window,
    ///                       Integer width);
    MsgpackRequest *window_set_width(int64_t window,
                                     int64_t width);
    
    /// @deprecated nvim API:
    /// Object window_get_var(Window window,
    ///                       String name);
    MsgpackRequest *window_get_var(int64_t window,
                                   QByteArray name);
    
    /// @deprecated nvim API:
    /// Object window_get_option(Window window,
    ///                          String name);
    MsgpackRequest *window_get_option(int64_t window,
                                      QByteArray name);
    
    /// @deprecated nvim API:
    /// void window_set_option(Window window,
    ///                        String name,
    ///                        Object value);
    MsgpackRequest *window_set_option(int64_t window,
                                      QByteArray name,
                                      QVariant value);
