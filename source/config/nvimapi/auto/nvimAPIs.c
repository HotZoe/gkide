...
<< NvimApiFunc("void", // return type
	           ...
	           false)
<< NvimApiFunc("void", // return type
               "nvim_err_write", // function name
	           QList<QString>()
                   << QString("String"),
	           false)
<< NvimApiFunc("void", // return type
               "nvim_err_writeln", // function name
	           QList<QString>()
                   << QString("String"),
	           false)
...
<< NvimApiFunc("Boolean", // return type
	           ...
	           false)
<< NvimApiFunc("Integer", // return type
               "buffer_line_count", // function name
	           QList<QString>()
                   << QString("Buffer"),
	           false)
<< NvimApiFunc("ArrayOf(String)", // return type
               "buffer_get_lines", // function name
	           QList<QString>()
                   << QString("Buffer")
                   << QString("Integer")
                   << QString("Integer")
	           ...
	           false)
<< NvimApiFunc("void", // return type
               "buffer_set_lines", // function name
	           QList<QString>()
                   << QString("Buffer")
                   << QString("Integer")
                   << QString("Integer")
	           ...
	           false)
<< NvimApiFunc("Object", // return type
               "buffer_get_var", // function name
	           QList<QString>()
                   << QString("Buffer")
                   << QString("String"),
	           false)
<< NvimApiFunc("Object", // return type
               "buffer_get_option", // function name
	           QList<QString>()
                   << QString("Buffer")
                   << QString("String"),
	           false)
<< NvimApiFunc("void", // return type
               "buffer_set_option", // function name
	           QList<QString>()
                   << QString("Buffer")
                   << QString("String")
                   << QString("Object"),
	           false)
<< NvimApiFunc("Integer", // return type
               "buffer_get_number", // function name
	           QList<QString>()
                   << QString("Buffer"),
	           false)
<< NvimApiFunc("String", // return type
               "buffer_get_name", // function name
	           QList<QString>()
                   << QString("Buffer"),
	           false)
<< NvimApiFunc("void", // return type
               "buffer_set_name", // function name
	           QList<QString>()
                   << QString("Buffer")
                   << QString("String"),
	           false)
<< NvimApiFunc("Boolean", // return type
               "buffer_is_valid", // function name
	           QList<QString>()
                   << QString("Buffer"),
	           false)
<< NvimApiFunc("ArrayOf(Integer, 2)", // return type
               "buffer_get_mark", // function name
	           QList<QString>()
                   << QString("Buffer")
                   << QString("String"),
	           false)
<< NvimApiFunc("Integer", // return type
               "buffer_add_highlight", // function name
	           QList<QString>()
                   << QString("Buffer")
                   << QString("Integer")
                   << QString("String")
	           ...
	           false)
<< NvimApiFunc("void", // return type
               "buffer_clear_highlight", // function name
	           QList<QString>()
                   << QString("Buffer")
                   << QString("Integer")
                   << QString("Integer")
	           ...
	           false)
<< NvimApiFunc("ArrayOf(Window)", // return type
               "tabpage_get_windows", // function name
	           QList<QString>()
                   << QString("Tabpage"),
	           false)
<< NvimApiFunc("Object", // return type
               "tabpage_get_var", // function name
	           QList<QString>()
                   << QString("Tabpage")
                   << QString("String"),
	           false)
<< NvimApiFunc("Window", // return type
               "tabpage_get_window", // function name
	           QList<QString>()
                   << QString("Tabpage"),
	           false)
<< NvimApiFunc("Boolean", // return type
               "tabpage_is_valid", // function name
	           QList<QString>()
                   << QString("Tabpage"),
	           false)
<< NvimApiFunc("void", // return type
               "ui_detach", // function name
	           QList<QString>(),
	           false)
<< NvimApiFunc("Object", // return type
               "ui_try_resize", // function name
	           QList<QString>()
                   << QString("Integer")
                   << QString("Integer"),
	           false)
<< NvimApiFunc("void", // return type
               "vim_command", // function name
	           QList<QString>()
                   << QString("String"),
	           false)
<< NvimApiFunc("void", // return type
               "vim_feedkeys", // function name
	           QList<QString>()
                   << QString("String")
                   << QString("String")
                   << QString("Boolean"),
	           false)
<< NvimApiFunc("Integer", // return type
               "vim_input", // function name
	           QList<QString>()
                   << QString("String"),
	           false)
<< NvimApiFunc("String", // return type
               "vim_replace_termcodes", // function name
	           QList<QString>()
                   << QString("String")
                   << QString("Boolean")
                   << QString("Boolean")
	           ...
	           false)
<< NvimApiFunc("String", // return type
               "vim_command_output", // function name
	           QList<QString>()
                   << QString("String"),
	           false)
<< NvimApiFunc("Object", // return type
               "vim_eval", // function name
	           QList<QString>()
                   << QString("String"),
	           false)
<< NvimApiFunc("Object", // return type
               "vim_call_function", // function name
	           QList<QString>()
                   << QString("String")
                   << QString("Array"),
	           false)
<< NvimApiFunc("Integer", // return type
               "vim_strwidth", // function name
	           QList<QString>()
                   << QString("String"),
	           false)
<< NvimApiFunc("ArrayOf(String)", // return type
               "vim_list_runtime_paths", // function name
	           QList<QString>(),
	           false)
<< NvimApiFunc("void", // return type
               "vim_change_directory", // function name
	           QList<QString>()
                   << QString("String"),
	           false)
<< NvimApiFunc("String", // return type
               "vim_get_current_line", // function name
	           QList<QString>(),
	           false)
<< NvimApiFunc("void", // return type
               "vim_set_current_line", // function name
	           QList<QString>()
                   << QString("String"),
	           false)
<< NvimApiFunc("void", // return type
               "vim_del_current_line", // function name
	           QList<QString>(),
	           false)
<< NvimApiFunc("Object", // return type
               "vim_get_var", // function name
	           QList<QString>()
                   << QString("String"),
	           false)
<< NvimApiFunc("Object", // return type
               "vim_get_vvar", // function name
	           QList<QString>()
                   << QString("String"),
	           false)
<< NvimApiFunc("Object", // return type
               "vim_get_option", // function name
	           QList<QString>()
                   << QString("String"),
	           false)
<< NvimApiFunc("void", // return type
               "vim_set_option", // function name
	           QList<QString>()
                   << QString("String")
                   << QString("Object"),
	           false)
<< NvimApiFunc("void", // return type
               "vim_out_write", // function name
	           QList<QString>()
                   << QString("String"),
	           false)
<< NvimApiFunc("void", // return type
               "vim_err_write", // function name
	           QList<QString>()
                   << QString("String"),
	           false)
<< NvimApiFunc("void", // return type
               "vim_report_error", // function name
	           QList<QString>()
                   << QString("String"),
	           false)
<< NvimApiFunc("ArrayOf(Buffer)", // return type
               "vim_get_buffers", // function name
	           QList<QString>(),
	           false)
<< NvimApiFunc("Buffer", // return type
               "vim_get_current_buffer", // function name
	           QList<QString>(),
	           false)
<< NvimApiFunc("void", // return type
               "vim_set_current_buffer", // function name
	           QList<QString>()
                   << QString("Buffer"),
	           false)
<< NvimApiFunc("ArrayOf(Window)", // return type
               "vim_get_windows", // function name
	           QList<QString>(),
	           false)
<< NvimApiFunc("Window", // return type
               "vim_get_current_window", // function name
	           QList<QString>(),
	           false)
<< NvimApiFunc("void", // return type
               "vim_set_current_window", // function name
	           QList<QString>()
                   << QString("Window"),
	           false)
<< NvimApiFunc("ArrayOf(Tabpage)", // return type
               "vim_get_tabpages", // function name
	           QList<QString>(),
	           false)
<< NvimApiFunc("Tabpage", // return type
               "vim_get_current_tabpage", // function name
	           QList<QString>(),
	           false)
<< NvimApiFunc("void", // return type
               "vim_set_current_tabpage", // function name
	           QList<QString>()
                   << QString("Tabpage"),
	           false)
<< NvimApiFunc("void", // return type
               "vim_subscribe", // function name
	           QList<QString>()
                   << QString("String"),
	           false)
<< NvimApiFunc("void", // return type
               "vim_unsubscribe", // function name
	           QList<QString>()
                   << QString("String"),
	           false)
<< NvimApiFunc("Integer", // return type
               "vim_name_to_color", // function name
	           QList<QString>()
                   << QString("String"),
	           false)
<< NvimApiFunc("Dictionary", // return type
               "vim_get_color_map", // function name
	           QList<QString>(),
	           false)
<< NvimApiFunc("Buffer", // return type
               "window_get_buffer", // function name
	           QList<QString>()
                   << QString("Window"),
	           false)
<< NvimApiFunc("ArrayOf(Integer, 2)", // return type
               "window_get_cursor", // function name
	           QList<QString>()
                   << QString("Window"),
	           false)
<< NvimApiFunc("void", // return type
               "window_set_cursor", // function name
	           QList<QString>()
                   << QString("Window")
                   << QString("ArrayOf(Integer, 2)"),
	           false)
<< NvimApiFunc("Integer", // return type
               "window_get_height", // function name
	           QList<QString>()
                   << QString("Window"),
	           false)
<< NvimApiFunc("void", // return type
               "window_set_height", // function name
	           QList<QString>()
                   << QString("Window")
                   << QString("Integer"),
	           false)
<< NvimApiFunc("Integer", // return type
               "window_get_width", // function name
	           QList<QString>()
                   << QString("Window"),
	           false)
<< NvimApiFunc("void", // return type
               "window_set_width", // function name
	           QList<QString>()
                   << QString("Window")
                   << QString("Integer"),
	           false)
<< NvimApiFunc("Object", // return type
               "window_get_var", // function name
	           QList<QString>()
                   << QString("Window")
                   << QString("String"),
	           false)
<< NvimApiFunc("Object", // return type
               "window_get_option", // function name
	           QList<QString>()
                   << QString("Window")
                   << QString("String"),
	           false)
<< NvimApiFunc("void", // return type
               "window_set_option", // function name
	           QList<QString>()
                   << QString("Window")
                   << QString("String")
                   << QString("Object"),
	           false)
<< NvimApiFunc("ArrayOf(Integer, 2)", // return type
               "window_get_position", // function name
	           QList<QString>()
                   << QString("Window"),
	           false)
<< NvimApiFunc("Tabpage", // return type
               "window_get_tabpage", // function name
	           QList<QString>()
                   << QString("Window"),
	           false)
<< NvimApiFunc("Boolean", // return type
               "window_is_valid", // function name
	           QList<QString>()
                   << QString("Window"),
	           false)
;
