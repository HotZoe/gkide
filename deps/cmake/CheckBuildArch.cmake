...
if(T_M_AMD64 OR T_X86_64 OR T_AMD64)
    option(host_os_supported_x64 "Host system support 64-bits." ON)
endif()

# check if we want to select one
if(ARCH_32_ENABLE AND host_os_supported_x86)
    option(HOST_OS_ARCH_32 "Host System is 32-bits." ON)
elseif(ARCH_64_ENABLE AND host_os_supported_x64)
    option(HOST_OS_ARCH_64 "Host System is 64-bits." ON)
else()
    if(CMAKE_SIZEOF_VOID_P EQUAL 8 AND host_os_supported_x64)
        option(HOST_OS_ARCH_64 "Host System is 64-bits." ON)
