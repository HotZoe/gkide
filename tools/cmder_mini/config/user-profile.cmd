...
set GKIDE_PROG_GIT=%GKIDE_MSYS2_USR_BIN_DIR%\git.exe
...
set GKIDE_PROG_MINGW32_MAKE=%GKIDE_MINGW_TOOLCHAIN_DIR%\mingw32-make.exe
...
%GKIDE_PROG_ECHO% -e "MINGW Toolchain : \033[33m%GKIDE_MINGW_TOOLCHAIN_DIR:~,-4%\\\\bin\033[0m"
%GKIDE_PROG_ECHO% -e "MSYS2 usr\\\\bin   : \033[33m%GKIDE_MSYS2_USR_BIN_DIR:~,-4%\\\\bin\033[0m"
...
rem Add MinGW
echo %GKIDE_MINGW_TOOLCHAIN_DIR%; >> %GKIDE_ROOT_DIR%\cmder_env_path_3
