...
set(qt5_lib_name ${CMAKE_STATIC_LIBRARY_PREFIX}qxcb${CMAKE_STATIC_LIBRARY_SUFFIX})
...
if(EXISTS ${QT5_LIB_QXCB})
    ...
    message(FATAL_ERROR "Do not find '${qt5_lib_name}' library for snail static build.")
endif()

# static build Qt5 bundled library: lib/libQt5XcbQpa.a
set(qt5_lib_name ${CMAKE_STATIC_LIBRARY_PREFIX}Qt5XcbQpa${CMAKE_STATIC_LIBRARY_SUFFIX})
...
set(qt5_lib_name ${CMAKE_STATIC_LIBRARY_PREFIX}Qt5ServiceSupport${CMAKE_STATIC_LIBRARY_SUFFIX})
...
set(qt5_lib_name ${CMAKE_STATIC_LIBRARY_PREFIX}Qt5ThemeSupport${CMAKE_STATIC_LIBRARY_SUFFIX})
...
set(qt5_lib_name ${CMAKE_STATIC_LIBRARY_PREFIX}Qt5DBus${CMAKE_STATIC_LIBRARY_SUFFIX})
...
set(qt5_lib_name ${CMAKE_STATIC_LIBRARY_PREFIX}Qt5EventDispatcherSupport${CMAKE_STATIC_LIBRARY_SUFFIX})
...
set(qt5_lib_name ${CMAKE_STATIC_LIBRARY_PREFIX}Qt5FontDatabaseSupport${CMAKE_STATIC_LIBRARY_SUFFIX})
...
set(sys_lib_names "fontconfig") # static libray come first
list(INSERT sys_lib_names 0 ${CMAKE_SHARED_LIBRARY_PREFIX}fontconfig${CMAKE_SHARED_LIBRARY_SUFFIX})
list(INSERT sys_lib_names 0 ${CMAKE_STATIC_LIBRARY_PREFIX}fontconfig${CMAKE_STATIC_LIBRARY_SUFFIX})
...
if(EXISTS ${SYS_LIB_FONTCONFIG})
    ...
    message(FATAL_ERROR "Do not find '${sys_lib_names}' library for snail static build.")
endif()

# static build Qt5 system library: libexpat.a, libexpat.so, expat
set(sys_lib_names "expat") # static libray come first
list(INSERT sys_lib_names 0 ${CMAKE_SHARED_LIBRARY_PREFIX}expat${CMAKE_SHARED_LIBRARY_SUFFIX})
list(INSERT sys_lib_names 0 ${CMAKE_STATIC_LIBRARY_PREFIX}expat${CMAKE_STATIC_LIBRARY_SUFFIX})
...
list(INSERT sys_lib_names 0 ${CMAKE_SHARED_LIBRARY_PREFIX}freetype${CMAKE_SHARED_LIBRARY_SUFFIX})
list(INSERT sys_lib_names 0 ${CMAKE_STATIC_LIBRARY_PREFIX}freetype${CMAKE_STATIC_LIBRARY_SUFFIX})
...
#
# provides functions needed by clients which take advantage of Xlib/XCB to mix calls to
...
list(INSERT sys_lib_names 0 ${CMAKE_SHARED_LIBRARY_PREFIX}X11-xcb${CMAKE_SHARED_LIBRARY_SUFFIX})
list(INSERT sys_lib_names 0 ${CMAKE_STATIC_LIBRARY_PREFIX}X11-xcb${CMAKE_STATIC_LIBRARY_SUFFIX})
...
set(qt5_lib_name ${CMAKE_STATIC_LIBRARY_PREFIX}xcb-static${CMAKE_STATIC_LIBRARY_SUFFIX})
...
set(qt5_lib_name ${CMAKE_STATIC_LIBRARY_PREFIX}qgif${CMAKE_STATIC_LIBRARY_SUFFIX})
...
set(qt5_lib_name ${CMAKE_STATIC_LIBRARY_PREFIX}qicns${CMAKE_STATIC_LIBRARY_SUFFIX})
...
set(qt5_lib_name ${CMAKE_STATIC_LIBRARY_PREFIX}qico${CMAKE_STATIC_LIBRARY_SUFFIX})
...
set(qt5_lib_name ${CMAKE_STATIC_LIBRARY_PREFIX}qjpeg${CMAKE_STATIC_LIBRARY_SUFFIX})
...
set(qt5_lib_name ${CMAKE_STATIC_LIBRARY_PREFIX}qtga${CMAKE_STATIC_LIBRARY_SUFFIX})
...
set(qt5_lib_name ${CMAKE_STATIC_LIBRARY_PREFIX}qtiff${CMAKE_STATIC_LIBRARY_SUFFIX})
...
set(qt5_lib_name ${CMAKE_STATIC_LIBRARY_PREFIX}qwbmp${CMAKE_STATIC_LIBRARY_SUFFIX})
...
set(qt5_lib_name ${CMAKE_STATIC_LIBRARY_PREFIX}qwebp${CMAKE_STATIC_LIBRARY_SUFFIX})
...
set(qt5_lib_name ${CMAKE_STATIC_LIBRARY_PREFIX}Qt5Widgets${CMAKE_STATIC_LIBRARY_SUFFIX})
...
set(qt5_lib_name ${CMAKE_STATIC_LIBRARY_PREFIX}Qt5Gui${CMAKE_STATIC_LIBRARY_SUFFIX})
...
list(INSERT sys_lib_names 0 ${CMAKE_SHARED_LIBRARY_PREFIX}png${CMAKE_SHARED_LIBRARY_SUFFIX})
list(INSERT sys_lib_names 0 ${CMAKE_SHARED_LIBRARY_PREFIX}png12${CMAKE_SHARED_LIBRARY_SUFFIX})
list(INSERT sys_lib_names 0 ${CMAKE_STATIC_LIBRARY_PREFIX}png${CMAKE_STATIC_LIBRARY_SUFFIX})
list(INSERT sys_lib_names 0 ${CMAKE_STATIC_LIBRARY_PREFIX}png12${CMAKE_STATIC_LIBRARY_SUFFIX})
...
set(qt5_lib_name ${CMAKE_STATIC_LIBRARY_PREFIX}qtharfbuzz${CMAKE_STATIC_LIBRARY_SUFFIX})
...
set(qt5_lib_name ${CMAKE_STATIC_LIBRARY_PREFIX}Qt5Core${CMAKE_STATIC_LIBRARY_SUFFIX})
...
list(INSERT sys_lib_names 0 ${CMAKE_SHARED_LIBRARY_PREFIX}icui18n${CMAKE_SHARED_LIBRARY_SUFFIX})
if(SNAIL_USE_STATIC_LIB_ICU)
    list(INSERT sys_lib_names 0 ${CMAKE_STATIC_LIBRARY_PREFIX}icui18n${CMAKE_STATIC_LIBRARY_SUFFIX})
endif()
...
list(INSERT sys_lib_names 0 ${CMAKE_SHARED_LIBRARY_PREFIX}icuuc${CMAKE_SHARED_LIBRARY_SUFFIX})
if(SNAIL_USE_STATIC_LIB_ICU)
    list(INSERT sys_lib_names 0 ${CMAKE_STATIC_LIBRARY_PREFIX}icuuc${CMAKE_STATIC_LIBRARY_SUFFIX})
endif()
...
list(INSERT sys_lib_names 0 ${CMAKE_SHARED_LIBRARY_PREFIX}icudata${CMAKE_SHARED_LIBRARY_SUFFIX})
if(SNAIL_USE_STATIC_LIB_ICU)
    list(INSERT sys_lib_names 0 ${CMAKE_STATIC_LIBRARY_PREFIX}icudata${CMAKE_STATIC_LIBRARY_SUFFIX})
endif()
...
set(qt5_lib_name ${CMAKE_STATIC_LIBRARY_PREFIX}qtpcre2${CMAKE_STATIC_LIBRARY_SUFFIX})
...
# The GLib provides the core application building blocks for libraries and applications written in C.
#
# It contains low-level libraries useful for providing data structure handling for C, portability
# wrappers and interfaces for such runtime functionality as an event loop, threads, dynamic loading
