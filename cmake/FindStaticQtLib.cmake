...
if(EXISTS ${QT5_LIB_QXCB})
    list(APPEND SNAIL_LINK_LIBS ${QT5_LIB_QXCB})
else()
    message(FATAL_ERROR
...
if(EXISTS ${QT5_LIB_QT5XCBQPA})
    list(APPEND SNAIL_LINK_LIBS ${QT5_LIB_QT5XCBQPA})
else()
    message(FATAL_ERROR
            "Do not find '${qt5_lib_name}' library for snail static build.")
endif()
...
if(EXISTS ${QT5_LIB_QT5SERVICESUPPORT})
    list(APPEND SNAIL_LINK_LIBS ${QT5_LIB_QT5SERVICESUPPORT})
else()
    message(FATAL_ERROR
            "Do not find '${qt5_lib_name}' library for snail static build.")
endif()
...
if(EXISTS ${QT5_LIB_QT5THEMESUPPORT})
    list(APPEND SNAIL_LINK_LIBS ${QT5_LIB_QT5THEMESUPPORT})
else()
    message(FATAL_ERROR
            "Do not find '${qt5_lib_name}' library for snail static build.")
endif()
...
if(EXISTS ${QT5_LIB_QT5DBUS})
    list(APPEND SNAIL_LINK_LIBS ${QT5_LIB_QT5DBUS})
else()
    message(FATAL_ERROR
            "Do not find '${qt5_lib_name}' library for snail static build.")
endif()
...
if(EXISTS ${QT5_LIB_QT5EVENTDISPATCHERSUPPORT})
    list(APPEND SNAIL_LINK_LIBS ${QT5_LIB_QT5EVENTDISPATCHERSUPPORT})
else()
    message(FATAL_ERROR
            "Do not find '${qt5_lib_name}' library for snail static build.")
endif()
...
if(EXISTS ${QT5_LIB_QT5FONTDATABASESUPPORT})
    list(APPEND SNAIL_LINK_LIBS ${QT5_LIB_QT5FONTDATABASESUPPORT})
else()
    message(FATAL_ERROR
            "Do not find '${qt5_lib_name}' library for snail static build.")
endif()
...
if(EXISTS ${SYS_LIB_FONTCONFIG})
    list(APPEND SNAIL_LINK_LIBS ${SYS_LIB_FONTCONFIG})
else()
    message(FATAL_ERROR
...
if(EXISTS ${SYS_LIB_EXPAT})
    list(APPEND SNAIL_LINK_LIBS ${SYS_LIB_EXPAT})
else()
    message(FATAL_ERROR
            "Do not find '${sys_lib_names}' library for snail static build.")
endif()
...
if(EXISTS ${SYS_LIB_FREETYPE})
    list(APPEND SNAIL_LINK_LIBS ${SYS_LIB_FREETYPE})
else()
    message(FATAL_ERROR
            "Do not find '${sys_lib_names}' library for snail static build.")
endif()
...
list(APPEND SNAIL_LINK_LIBS ${X11_X11_LIB})
list(APPEND SNAIL_LINK_LIBS ${X11_Xi_LIB})
...
if(EXISTS ${SYS_LIB_X11_XCB})
    list(APPEND SNAIL_LINK_LIBS ${SYS_LIB_X11_XCB})
else()
    message(FATAL_ERROR
            "Do not find '${sys_lib_names}' library for snail static build.")
endif()
...
if(EXISTS ${QT5_LIB_XCB_STATIC})
    list(APPEND SNAIL_LINK_LIBS ${QT5_LIB_XCB_STATIC})
else()
    message(FATAL_ERROR
            "Do not find '${qt5_lib_name}' library for snail static build.")
endif()
...
if(EXISTS ${SYS_LIB_XCB})
    list(APPEND SNAIL_LINK_LIBS ${SYS_LIB_XCB})
else()
    message(FATAL_ERROR
            "Do not find '${sys_lib_names}' library for snail static build.")
endif()
...
if(EXISTS ${QT5_LIB_QGIF})
    list(APPEND SNAIL_LINK_LIBS ${QT5_LIB_QGIF})
else()
    message(FATAL_ERROR
            "Do not find '${qt5_lib_name}' library for snail static build.")
endif()
...
if(EXISTS ${QT5_LIB_QICNS})
    list(APPEND SNAIL_LINK_LIBS ${QT5_LIB_QICNS})
else()
    message(FATAL_ERROR
            "Do not find '${qt5_lib_name}' library for snail static build.")
endif()
...
if(EXISTS ${QT5_LIB_QICO})
    list(APPEND SNAIL_LINK_LIBS ${QT5_LIB_QICO})
else()
    message(FATAL_ERROR
            "Do not find '${qt5_lib_name}' library for snail static build.")
endif()
...
if(EXISTS ${QT5_LIB_QJPEG})
    list(APPEND SNAIL_LINK_LIBS ${QT5_LIB_QJPEG})
else()
    message(FATAL_ERROR
            "Do not find '${qt5_lib_name}' library for snail static build.")
endif()
...
if(EXISTS ${QT5_LIB_QTGA})
    list(APPEND SNAIL_LINK_LIBS ${QT5_LIB_QTGA})
else()
    message(FATAL_ERROR
            "Do not find '${qt5_lib_name}' library for snail static build.")
endif()
...
if(EXISTS ${QT5_LIB_QTIFF})
    list(APPEND SNAIL_LINK_LIBS ${QT5_LIB_QTIFF})
else()
    message(FATAL_ERROR
            "Do not find '${qt5_lib_name}' library for snail static build.")
endif()
...
if(EXISTS ${QT5_LIB_QWBMP})
    list(APPEND SNAIL_LINK_LIBS ${QT5_LIB_QWBMP})
else()
    message(FATAL_ERROR
            "Do not find '${qt5_lib_name}' library for snail static build.")
endif()
...
if(EXISTS ${QT5_LIB_QWEBP})
    list(APPEND SNAIL_LINK_LIBS ${QT5_LIB_QWEBP})
else()
    message(FATAL_ERROR
            "Do not find '${qt5_lib_name}' library for snail static build.")
endif()
...
if(EXISTS ${QT5_LIB_QT5WIDGETS})
    list(APPEND SNAIL_LINK_LIBS ${QT5_LIB_QT5WIDGETS})
else()
    message(FATAL_ERROR
            "Do not find '${qt5_lib_name}' library for snail static build.")
endif()
...
if(EXISTS ${QT5_LIB_QT5GUI})
    list(APPEND SNAIL_LINK_LIBS ${QT5_LIB_QT5GUI})
else()
    message(FATAL_ERROR
            "Do not find '${qt5_lib_name}' library for snail static build.")
endif()
...
if(EXISTS ${SYS_LIB_PNG})
    list(APPEND SNAIL_LINK_LIBS ${SYS_LIB_PNG})
else()
    message(FATAL_ERROR
            "Do not find '${sys_lib_names}' library for snail static build.")
endif()
...
if(EXISTS ${QT5_LIB_QTHARFBUZZ})
    list(APPEND SNAIL_LINK_LIBS ${QT5_LIB_QTHARFBUZZ})
else()
    message(FATAL_ERROR
            "Do not find '${qt5_lib_name}' library for snail static build.")
endif()
...
if(EXISTS ${QT5_LIB_QT5CORE})
    list(APPEND SNAIL_LINK_LIBS ${QT5_LIB_QT5CORE})
else()
    message(FATAL_ERROR
            "Do not find '${qt5_lib_name}' library for snail static build.")
endif()
...
if(EXISTS ${SYS_LIB_ICUI18N})
    list(APPEND SNAIL_LINK_LIBS ${SYS_LIB_ICUI18N})
else()
    message(FATAL_ERROR
            "Do not find '${sys_lib_names}' library for snail static build.")
endif()
...
if(EXISTS ${SYS_LIB_ICUUC})
    list(APPEND SNAIL_LINK_LIBS ${SYS_LIB_ICUUC})
else()
    message(FATAL_ERROR
            "Do not find '${sys_lib_names}' library for snail static build.")
endif()
...
if(EXISTS ${SYS_LIB_ICUDATA})
    list(APPEND SNAIL_LINK_LIBS ${SYS_LIB_ICUDATA})
else()
    message(FATAL_ERROR
            "Do not find '${sys_lib_names}' library for snail static build.")
endif()
...
find_library(SYS_LIB_M
             ...
             PATHS ${multiarch_seeks_dirs})
if(EXISTS ${SYS_LIB_M})
    list(APPEND SNAIL_LINK_LIBS ${SYS_LIB_M})
else()
    message(FATAL_ERROR
            "Do not find '${sys_lib_names}' library for snail static build.")
endif()
...
find_library(SYS_LIB_Z
             ...
             PATHS ${multiarch_seeks_dirs})
if(EXISTS ${SYS_LIB_Z})
    list(APPEND SNAIL_LINK_LIBS ${SYS_LIB_Z})
else()
    message(FATAL_ERROR
            "Do not find '${sys_lib_names}' library for snail static build.")
endif()
...
if(EXISTS ${QT5_LIB_QTPCRE2})
    list(APPEND SNAIL_LINK_LIBS ${QT5_LIB_QTPCRE2})
else()
    message(FATAL_ERROR
            "Do not find '${qt5_lib_name}' library for snail static build.")
endif()
...
if(EXISTS ${SYS_LIB_DL})
    list(APPEND SNAIL_LINK_LIBS ${SYS_LIB_DL})
else()
    message(FATAL_ERROR
            "Do not find '${sys_lib_names}' library for snail static build.")
endif()
...
if(EXISTS ${SYS_LIB_GTHREAD20})
    list(APPEND SNAIL_LINK_LIBS ${SYS_LIB_GTHREAD20})
else()
    message(FATAL_ERROR
            "Do not find '${sys_lib_names}' library for snail static build.")
endif()
...
if(EXISTS ${SYS_LIB_GLIB20})
    list(APPEND SNAIL_LINK_LIBS ${SYS_LIB_GLIB20})
else()
    message(FATAL_ERROR
            "Do not find '${sys_lib_names}' library for snail static build.")
endif()
